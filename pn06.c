...
**      precession.
**
**  4)  The matrix rb transforms vectors from GCRS to J2000 mean equator
**      and equinox by applying frame bias.
**
**  5)  The matrix rp transforms vectors from J2000 mean equator and
...
/* Bias-precession Fukushima-Williams angles of J2000 = frame bias. */
